package com.newdjk.bdmember.scan.activity;
...
import com.newdjk.bdmember.scan.camera.CameraManager;
import com.newdjk.bdmember.scan.decoding.CaptureActivityHandler;
import com.newdjk.bdmember.scan.decoding.InactivityTimer;
import com.newdjk.bdmember.scan.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private LinearLayout liearTitlebar;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        liearTitlebar = view.findViewById(R.id.liear_titlebar);
        ivTopLeft = view.findViewById(R.id.top_left);
        tvTopRight = view.findViewById(R.id.tv_right);
        tvTopTitle = view.findViewById(R.id.top_title);
        tvOpenLight = view.findViewById(R.id.tv_open_light);
    ...
    private void initViews() {
        ivTopLeft.setOnClickListener(v -> getActivity().finish());
        tvOpenLight.setOnClickListener(v -> {
            if (isOpen) {
        ...
        tvTopTitle.setText(getString(R.string.scan));
        tvTopRight.setText(getString(R.string.album));
        ...
        liearTitlebar.setBackgroundColor(getContext().getResources().getColor(R.color.panel_black));
