...
import com.newdjk.bdmember.utils.DefaultMediaLoader;
import com.newdjk.bdmember.utils.FileUtil;
import com.newdjk.bdmember.utils.IMediaLoader;
import com.newdjk.bdmember.utils.ScreenUtils;
...
public class MultiImageUploadView extends FlowLayout {
    ...
    int numCol = 3;// 图片列数
    int max = 6;
    int closeRes = R.mipmap.ic_delete_photo;// 删除按钮的资源
